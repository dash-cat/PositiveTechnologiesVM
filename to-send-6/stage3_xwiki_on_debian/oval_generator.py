...
vulners_search_params = {
    "query": f"cpe:2.3:a:{manufacturer}:{application_name}",
    "type": "vulnerability"
}
...
if __name__ == "__main__":
    ...
    nvd_vulns = get_cves_nvd(cve_api_url, cves_search_params)
    
    print("Getting CVEs from Vulners...")
    vulners_vulns = get_cves_vulners(vulners_api_url, vulners_search_params)
    
    # Combine both sources
    all_vulns = nvd_vulns + vulners_vulns

    print("Parsing vulnerabilities...")
    vulns = parse_vulns(all_vulns)
