...
Выполнил ещё группу из пяти заданий.

Во время попытки инсталлировать Zimbra на Debian 12 наткнулся на форумный пост, в котором объясняется, что данная система этим ПО не поддерживается: https://forums.zimbra.org/viewtopic.php?t=72091

Есть также вопрос: подскажите, пожалуйста, когда можно ожидать завершения проверки этих заданий: Keycloack (этап 2), strongSwan (этап 2), Python3 (этап 2), nginx unit (этап 2)?

Прошу выдать ещё 10 заданий, возможно они появились за это время :)

P.S. Буду благодарен, если платформа будет Linux.
