...
if __name__ == "__main__":
    ...
    for m in manufacturer:
        ...
        params = {"virtualMatchString": f"cpe:2.3:a:{m}:{application_name}"}
        nvd_vulns.extend(get_cves_nvd(cve_api_url, params))
    
    print("Getting CVEs from Vulners...")
    vulners_vulns = []
    for m in manufacturer:
        params = {"query": f"cpe:2.3:a:{m}:{application_name}", "type": "vulnerability"}
        vulners_vulns.extend(get_cves_vulners(vulners_api_url, params))
